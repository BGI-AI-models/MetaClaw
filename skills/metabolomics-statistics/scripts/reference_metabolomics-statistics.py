...
Usage:
    python scripts/reference_metabolomics-statistics.py --input <data.csv> --output <dir> --method ttest
    python scripts/reference_metabolomics-statistics.py --demo --output <dir>
"""
...
SKILL_NAME = "metabolomics-statistics"
SKILL_VERSION = "0.5.0"
...
def write_report(
    ...
    cmd = f"python scripts/reference_metabolomics-statistics.py --input <input.csv> --output {output_dir}"
    for k, v in params.items():
        cmd += f" --{k.replace('_', '-')} {v}"
