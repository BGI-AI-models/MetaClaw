...
Usage:
    python scripts/reference_metabolomics-pathway-enrichment.py --input <features.csv> --output <dir>
    python scripts/reference_metabolomics-pathway-enrichment.py --demo --output <dir>
"""
...
SKILL_NAME = "metabolomics-pathway-enrichment"
SKILL_VERSION = "0.5.0"
