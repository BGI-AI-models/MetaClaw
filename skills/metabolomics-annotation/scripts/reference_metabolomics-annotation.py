...
Usage:
    python scripts/reference_metabolomics-annotation.py --input <data.csv> --output <dir> --database hmdb
    python scripts/reference_metabolomics-annotation.py --demo --output <dir>
"""
...
SKILL_NAME = "metabolomics-annotation"
SKILL_VERSION = "0.5.0"
...
def write_report(
    ...
    cmd = f"python scripts/reference_metabolomics-annotation.py --input <input.csv> --output {output_dir}"
    for k, v in params.items():
        cmd += f" --{k.replace('_', '-')} {v}"
