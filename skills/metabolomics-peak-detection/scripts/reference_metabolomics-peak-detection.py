...
Usage:
    python scripts/reference_metabolomics-peak-detection.py --input <data.csv> --output <dir>
    python scripts/reference_metabolomics-peak-detection.py --demo --output <dir>
"""
...
SKILL_NAME = "metabolomics-peak-detection"
SKILL_VERSION = "0.5.0"
