...
Usage:
    python scripts/reference_metabolomics-quantification.py --input <features.csv> --output <dir>
    python scripts/reference_metabolomics-quantification.py --demo --output <dir>
"""
...
SKILL_NAME = "metabolomics-quantification"
SKILL_VERSION = "0.5.0"
