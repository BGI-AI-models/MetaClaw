...
Usage:
    python scripts/reference_metabolomics-xcms-preprocessing.py --input <data.mzML> [<data2.mzML> ...] --output <dir>
    python scripts/reference_metabolomics-xcms-preprocessing.py --demo --output <dir>
"""
...
SKILL_NAME = "metabolomics-xcms-preprocessing"
SKILL_VERSION = "0.5.0"
...
def write_report(
    ...
    cmd = f"python scripts/reference_metabolomics-xcms-preprocessing.py --output {output_dir}"
    for k, v in params.items():
        cmd += f" --{k.replace('_', '-')} {v}"
