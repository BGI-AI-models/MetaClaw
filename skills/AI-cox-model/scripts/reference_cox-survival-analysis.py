"""
reference_cox-survival-analysis.py — TEMPLATE (read-only at /pipeline/scripts/ inside the
downstream container). DO NOT run this directly for real analyses: copy it to
/job/reproducibility/generated_scripts/cox-survival-analysis_<YYYYMMDD-HHMMSS>.py, customize
for your dataset, then invoke:

    bash gateway/run_downstream.sh <job-id> --skills cox-survival-analysis

Cox proportional-hazards survival analysis.

Contract:
    --job-dir <path>   (default: /job)
    Reads    : <job-dir>/stage/coxsurvival
    Writes   : <job-dir>/analysis/cox-survival-analysis/
    Meta     : <job-dir>/analysis/cox-survival-analysis/cox-survival-analysis_meta.json
"""
...
ANALYSIS_SUBDIR = "cox-survival-analysis"
STAGE_SUBDIR = "coxsurvival"  # may be None
