...
Usage:
    python scripts/reference_metabolomics-de.py --input <features.csv> --output <dir>
    python scripts/reference_metabolomics-de.py --demo --output <dir>
"""
