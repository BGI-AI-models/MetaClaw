...
Usage:
    python scripts/reference_metabolomics-normalization.py --input <data.csv> --output <dir> --method median
    python scripts/reference_metabolomics-normalization.py --demo --output <dir>
"""
...
SKILL_NAME = "metabolomics-normalization"
SKILL_VERSION = "0.5.0"
...
def write_report(
    ...
    cmd = f"python scripts/reference_metabolomics-normalization.py --input <input.csv> --output {output_dir}"
    for k, v in params.items():
        cmd += f" --{k.replace('_', '-')} {v}"
